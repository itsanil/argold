...
<a class="btn btn-primary btn-sm" href="{{ route('permission.add') }}">Add New Permission</a>
@endsection
          ...
          <tbody>
            @foreach($permissions as $permission)
              <tr>
               ...
               <!--  <td>
                  <a class="btn btn-secondary btn-sm" href="{{ route('permission.edit', $permission->id) }}">Edit</a>
