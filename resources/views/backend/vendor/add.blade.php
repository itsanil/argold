...
<section class="content">
  ...
  <div class="container-fluid">
    <div class="card-body">
    <!-- <br> -->
      <form role="form" id="forms"  method="post" action="{{ route('vendor.store') }}">
      {{ csrf_field() }}
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="bankname" class="form-control" id="bankname" placeholder="Enter Transaction Code" >
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="bankaccountno">Bank Account Number</label>
              <input type="number" name="bankaccountno" class="form-control" id="bankaccountno" placeholder="Enter Account Number" >
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label for="ifsc_code">IFSC Code</label>
              <input type="text" name="ifsccode" class="form-control" id="ifsccode" placeholder="Enter IFSC Code" >
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
