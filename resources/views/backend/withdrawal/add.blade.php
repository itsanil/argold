...
<section class="content">
  ...
  <div class="container-fluid">
    <div class="card-body">
    <!-- <br> -->
      <form role="form" id="forms"  method="post" action="{{ route('withdrawal.store') }}">
      {{ csrf_field() }}
        <div class="row">
          <div class="col-md-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" value="0" name="exchange_amt" min="0" class="form-control" id="exchange_amt" placeholder="Enter Amount">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
